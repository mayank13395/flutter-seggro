...
_controller.addListener(filterCrop); 
 ...
 bool get _isAppBarExpanded {
  ...
  void setState(fn) {
   ...
   List <Crop> myTempCropList = [];
    ...
    //            myCopiedCropList.remove(f)
    //       });
    // myCopiedCropList = [];
   var x=  _controller.text;
  print("my input feild val......................$x");
  // print("croplist...........................$_cropList.toString()");
  myCopiedCropList.forEach((crop){
    // print("my crop ....................${crop.name}");
    
    if(crop.name.toLowerCase().contains(x) ){
      print("searched crops..............${crop.name}");

      myTempCropList.add(crop);
      ...
      // myCopiedCropList = _cropList.where(
      //               (crop) => (crop.name.contains(x) )
      //           );
      // // myCopiedCropList.removeWhere((cr)=>
      // //   cr.name == crop.name
      // // );
      //   setState(() {   });
    }
 ...
 myCopiedCropList.removeWhere( (e) => myTempCropList.contains(e));
        ...
        //  myCopiedCropList = myTempCropList;
          //  isFocused 
  ...
  myCopiedCropList = _cropList;
    ...
    return GestureDetector(
      ...
      if (!currentFocus.hasPrimaryFocus) {
          ...
          body: _buildBody(myCopiedCropList),
          //  Container(
          //   color: Colors.grey,
          // ),
        ),
                           ...
                           controller: _controller,
                              decoration: new InputDecoration(
                                contentPadding: EdgeInsets.all(10.0),
                                  ...
                                  filled: true,
                                  hintStyle: new TextStyle(color: isFocused ? Colors.green :Colors.grey[700] ),
