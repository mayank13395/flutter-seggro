...
class _SecondQuestion  extends State<SecondQuestion> with TickerProviderStateMixin {
...
return ["First", "Second", "Third","Fourth"];
 ...
 bool isSelected = false;
  ...
  int _animationDuration = 200;
   ...
   List<Color> _widgetColorarr = [Colors.white,Colors.white,Colors.white,Colors.white];
   List<Color> _selectedBorder = [Colors.white,Colors.white,Colors.white,Colors.white];
   List<Color> _selectedTextColor = [Colors.black,Colors.black,Colors.black,Colors.black];
  ...
  void animate_selected_option(option,listVal) {
    ...
    QuestionsData().addData(2, listVal);
  ...
  fit: BoxFit.fill,
      ...
      child: Container(
        ...
        child: Center(child: Container(
          // padding: EdgeInsets.all(20),
          child: Text("This is Second Question......... ",textAlign: TextAlign.center,style: TextStyle(color: Colors.black87,fontSize: 26),))),),
      ),
