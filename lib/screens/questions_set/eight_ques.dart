...
class EightQuestion extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return _EightQuestion();
  }

}

class _EightQuestion  extends State<EightQuestion> with TickerProviderStateMixin {
  ...
  var x =  QuestionsData().getSelectedQuestionData(8);
  print("selected questions data.............$x");
...
return ["First", "Second", "Third"];
 ...
 bool isSelected = false;
  ...
  void animateSelectedOptions(option,listval) {
    setState(() {
   ...
   print("tttttttttttttttttttttttttttttttttttt${listval}");
    QuestionsData().addData(8,listval );
    // ImageService().
  ...
  ListView myList = new ListView.builder(
    ...
    return GestureDetector(
              onTap: (){
                ...
                animateSelectedOptions(i,list[i]);
