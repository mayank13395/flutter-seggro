...
class SixthQuestion extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return _SixthQuestion();
  }

}

class _SixthQuestion  extends State<SixthQuestion> with TickerProviderStateMixin {
...
return ["First", "Second", "Third"];
 ...
 bool isSelected = false;
  ...
  void animate_selected_option(option,listVal) {
    ...
    QuestionsData().addData(6, listVal);
    ...
    children: <Widget>[
      ...
      child: Container(
        ...
        child: Center(child: Container(
          padding: EdgeInsets.all(20),
          child: Text("THis is Sixth Question. ",textAlign: TextAlign.center,style: TextStyle(color: Colors.black87,fontSize: 26),))),),
      ),
