...
class TenthQuestion extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return _TenthQuestion();
  }

}

class _TenthQuestion  extends State<TenthQuestion> with TickerProviderStateMixin {
...
return ["First", "Second", "Third"];
 ...
 bool isSelected = false;
  ...
  void animate_selected_option(option,listVal) {
    ...
    QuestionsData().addData(10, listVal);
    ...
    children: <Widget>[
      ...
      child: Container(
        ...
        child: Center(child: Container(
          padding: EdgeInsets.all(20),
          child: Text("This is Tenth Question. ",textAlign: TextAlign.center,style: TextStyle(color: Colors.black87,fontSize: 26),))),),
      ),
