...
class _SeventhQuestion  extends State<SeventhQuestion> with TickerProviderStateMixin {
...
return ["First", "Second", "Third"];
 ...
 bool isSelected = false;
  ...
  void animate_selected_option(option,listVal) {
    ...
    QuestionsData().addData(7, listVal);
    ...
    children: <Widget>[
      ...
      child: Container(
        ...
        child: Center(child: Container(
          padding: EdgeInsets.all(20),
          child: Text("THis is Seventh Question ",textAlign: TextAlign.center,style: TextStyle(color: Colors.black87,fontSize: 26),))),),
      ),
