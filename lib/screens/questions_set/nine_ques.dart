...
class NinthQuestion extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return _NinthQuestion();
  }

}

class _NinthQuestion  extends State<NinthQuestion> with TickerProviderStateMixin {
...
return ["First", "Second", "Third"];
 ...
 bool isSelected = false;
  ...
  void animate_selected_option(option,listVal) {
    ...
    QuestionsData().addData(9, listVal);
    ...
    children: <Widget>[
      ...
      child: Container(
        ...
        child: Center(child: Container(
          padding: EdgeInsets.all(20),
          child: Text("This is ninth Question. ",textAlign: TextAlign.center,style: TextStyle(color: Colors.black87,fontSize: 26),))),),
      ),
