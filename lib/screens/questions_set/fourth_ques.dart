...
class _FourthQuestion  extends State<FourthQuestion> with TickerProviderStateMixin {
...
return ["First", "Second", "Third"];
 ...
 bool isSelected = false;
  ...
  void animate_selected_option(option,listVal) {
    ...
    QuestionsData().addData(4, listVal);
    ...
    children: <Widget>[
      ...
      child: Container(
        ...
        child: Center(child: Container(
          padding: EdgeInsets.all(20),
          child: Text("This is Fifth Question. ",textAlign: TextAlign.center,style: TextStyle(color: Colors.black87,fontSize: 26),))),),
      ),
