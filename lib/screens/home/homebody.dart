...
class _HomeBodyState extends State<HomeBody> {
 ...
 bool get _isAppBarExpanded {
  ...
  Material _buildBody() {
          ...
          SliverGrid(
            ...
            delegate: SliverChildBuilderDelegate(
                ...
                /// uncomment the following line:
                 if (i > 9) return null;
                   print(" item found...........ttttttttttttttttttttttttttttttttttttttttt.... $myCopiedCropList");
                 
            //      if(myCopiedCropList.isEmpty) {
            //        print("no item found...........ttttttttttttttttttttttttttttttttttttttttt....");
            //        return  Visibility(
   ...
   Widget listItem(String name, String imageUrl , double mr) => 
   Container(
    ...
    color: Colors.white,
                      ...
                      onTap: () {
                        ...
                        setState(() {
                          ...
                          QuestionsData().cropName = name;
                          // cropName = $;
                          // // print("item-selected" + cropName);
                          // ImageService().setCropName(cropName)

                          // CropDetails.cropName = cropName;
                          Navigator.of(context)
                              .pushReplacementNamed(Routes.questions_set);
                        });
                      },
                      child: Container(
